\usepackage{hyperref}\chapter{Lur'e systems}
...
\begin{theorem}
    A \textbf{Autonomous Lur'e system} is absolutely stable in sector $[0,k]$ if the linear part is asymptotically stable and exists a real number $q$ such that
    \[
